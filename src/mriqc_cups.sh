...
#SBATCH --job-name=mriqc_cups
#SBATCH --account=cgratton-ic
# Outputs ----------------------------------
#SBATCH --mail-user=amt89@illinois.edu
#SBATCH --mail-type=ALL
#SBATCH --output=/projects/illinois/las/psych/cgratton/networks-pm/7t/mriqc-cups.out
# ------------------------------------------
...
WORK_DIR="/projects/illinois/las/psych/cgratton/networks-pm/7t/temp_mriqc_cups"
