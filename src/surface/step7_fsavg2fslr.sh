...
matlab -nodisplay -nosplash -r "addpath(genpath('${SCRIPT_DIR}')); PostFreeSurferPipeline_fsavg2fslr('${SUBJECT_ID}','${PARAMS}'); exit;" > ${LOG_DIR}/fsavg2fslr_${SUBJECT_ID}.log 2>&1
